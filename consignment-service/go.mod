module github.com/AzusaChino/daphne/consignment-service

go 1.17

require (
	github.com/AzusaChino/daphne/vessel-service v0.0.0-20210914031852-6e7b02831281
	github.com/AzusaChino/ribes v0.0.2
