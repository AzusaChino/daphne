...
func (s *handler) GetAll(ctx context.Context, _ *pb.Request, res *pb.Response) error {
...
func (s *handler) ValidateToken(_ context.Context, req *pb.Token, res *pb.Token) error {
